    ...
    <div>
      ...
      <main>
        <div className="form-container">
          ...
          <span style={{ color: "red" }} hidden={!validateFName ? "" : "false"}>
          ...
          <span style={{ color: "red" }} hidden={!validateLName ? "" : "false"}>
          ...
          <div className="input-field">
            ...
            <span
              style={{ color: "red" }}
              hidden={!validatePassCompare ? "" : "false"}
            >
